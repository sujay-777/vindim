...
//   const handleSend = () => {
//     // send data if needed, then navigate
//     navigate("/pages/hahaha/Chatbot", { state: { idea: text } });
//   };
...
//           {/* Transparent Input Box with Send Button */}
//           <div className="relative w-[400px] max-w-[90%]">
//             <textarea
//               placeholder="Type your idea and we'll build it together."
//               value={text}
//               onChange={(e) => setText(e.target.value)}
//               className="w-full h-32 px-4 py-3 rounded-2xl bg-black/40 backdrop-blur-md border border-white/10 shadow-lg text-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-400 resize-none pr-12"
//               style={{ fontSize: "0.875rem" }}
//             ></textarea>

//             {/* Conditionally show button if text length > 5 */}
//             {text.length > 5 && (
//               <button
//                 onClick={handleSend}
//                 className="absolute bottom-3 right-3 bg-purple-500 hover:bg-purple-600 text-white p-2 rounded-full shadow-lg transition"
//               >
//                 <ArrowRight size={18} />
//               </button>
//             )}
...
function Getstarted() {
  ...
  // const handleSend = () => {
  //   navigate("/chatbot", { state: { idea: text } });
  // };
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center -mt-20 space-y-4">
          ...
          <div className="relative w-[400px] max-w-[90%]">
            ...
            {text.length > 5 && (
              <button
                onClick={() => window.location.href = "/pages/chatbot.jsx"}
                className="absolute bottom-3 right-3 bg-purple-500 hover:bg-purple-600 text-white p-2 rounded-full shadow-lg transition"
              >
                <ArrowRight size={18} />
              </button>
